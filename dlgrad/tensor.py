...
class Tensor:
    ...
    def clamp(self, min: int | None = None, max: int | None = None) -> Tensor:
        """
        Clamps all elements below min to min and above max to max.
        If either one is None, then clamp using the other value.
        If both are None, return input Tensor.
        ...
        Returns:
            A tensor of the same shape as input clamped.
        """
